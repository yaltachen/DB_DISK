...
func main() {
	username := "test00123"
	token := "feac4d0ac07a08f1d0cd480275ecb1255d083432"
	filehash := "6AF35F3B06D8616E7C171E096D48D9A283351D4B"
	// 1. 请求初始化分块上传接口
	...
	// 3. 请求分块上传接口
	filename := "E:/安装包/go1.9.4.windows-amd64.msi"
	...
	resp, err = http.PostForm(
		...
		url.Values{
			...
			"filehash": {filehash},
			"filesize": {"95502336"},
			"filename": {"go1.9.4.windows-amd64.msi"},
			"uploadid": {uploadID},
		})
